...
def create_clean_blank(
    ...
    header_text = f"Бланк ответа № {display_number}"
    h_size = 15
    ...
    line_end_x = page_width - margin - 140 - 15
